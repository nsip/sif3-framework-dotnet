...
namespace Sif.Framework.Consumers
{
	...
	public class BasicConsumer<T> : Consumer<T, List<T>, string>, IBasicConsumer<T> where T : ISifRefId<string>
	{
		...
		/// <summary>
		/// <see cref="Consumer{TSingle,TMultiple,TPrimaryKey}.Consumer(Environment, WebProxy)">Consumer</see>
		/// </summary>
		public BasicConsumer(Environment environment, WebProxy webProxy = null)
			: base(environment, webProxy)
		{
		}

		/// <summary>
		/// <see cref="Consumer{TSingle,TMultiple,TPrimaryKey}.Consumer(string, string, string, string, WebProxy)">Consumer</see>
		/// </summary>
		public BasicConsumer(string applicationKey, string instanceId = null, string userToken = null, string solutionId = null, WebProxy webProxy = null)
			: base(applicationKey, instanceId, userToken, solutionId, webProxy)
		{
		}
