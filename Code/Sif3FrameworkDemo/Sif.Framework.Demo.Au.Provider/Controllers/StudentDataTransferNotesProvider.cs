...
{
    public class StudentDataTransferNotesProvider : BasicProvider<StudentDataTransferNote>
    {
        public StudentDataTransferNotesProvider() : base(
            new StudentDataTransferNoteService(),
